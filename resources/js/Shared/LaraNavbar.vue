            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <NavLink :href="route('inventory-entries.index')" :active="route().current('inventory-entries.index')">
                            Entradas
                        </NavLink>
                        <NavLink :href="route('inventory-outs.index')" :active="route().current('inventory-outs.index')">
                            Salidas
                        </NavLink>
